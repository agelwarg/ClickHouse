...
void DataTypeFixedString::deserializeTextCSV(IColumn & column, ReadBuffer & istr, const char delimiter, bool rfc_compliant) const
{
    read(*this, column, [&istr,delimiter,rfc_compliant](ColumnFixedString::Chars_t & data) { readCSVStringInto(data, istr, delimiter, rfc_compliant); });
}
