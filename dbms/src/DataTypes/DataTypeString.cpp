...
void DataTypeString::deserializeTextCSV(IColumn & column, ReadBuffer & istr, const char delimiter, bool rfc_compliant) const
{
    read(column, [&](ColumnString::Chars_t & data) { readCSVStringInto(data, istr, delimiter, rfc_compliant); });
}
